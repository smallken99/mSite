...
def get_statistics():
    ...
    where `status`= '2'  and `year_month` in ('2023-08','2023-10','2023-11')
    ...
    for d in data:
        ...
        value_2023_07 = d['2023-08'] if not pd.isna(d['2023-08']) else '0'
        value_2023_08 = d['2023-10'] if not pd.isna(d['2023-10']) else '0'
        value_2023_10 = d['2023-11'] if not pd.isna(d['2023-11']) else '0'

        new_dict = {'item_description': item_description, 
                    '2023-08': int(value_2023_07),
                    '2023-10': int(value_2023_08),
                    '2023-11': int(value_2023_10),
                    }
