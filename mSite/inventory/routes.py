...
def get_statistics():
    ...
    where `status`= '2'  and `year_month` in ('2024-02','2024-03','2024-04')
    ...
    for d in data:
        ...
        value_2024_03 = d['2024-03'] if not pd.isna(d['2024-03']) else '0'
        value_2024_04 = d['2024-04'] if not pd.isna(d['2024-04']) else '0'

        new_dict = {'item_description': item_description, 
                    '2024-02': int(value_2024_02),
                    '2024-03': int(value_2024_03),
                    '2024-04': int(value_2024_04),
                    }
